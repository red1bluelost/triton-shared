...
// CHECK-DAG:       [[VAR_2_:%.+]] = builtin.unrealized_conversion_cast [[PARAM_1_]] : !tt.ptr<i32> to !ptr.ptr<#ptr.generic_space>
...
// CHECK:           } -> tensor<16xi32>
// CHECK:           [[VAR_7_:%.+]] = tensor.empty() : tensor<16x!ptr.ptr<#ptr.generic_space>>
// CHECK:           [[VAR_8_:%.+]] = linalg.fill ins([[VAR_3_]] : !ptr.ptr<#ptr.generic_space>) outs([[VAR_7_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>) -> tensor<16x!ptr.ptr<#ptr.generic_space>>
// CHECK:           [[VAR_9_:%.+]] = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel"]} ins([[VAR_8_]], [[VAR_6_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>, tensor<16xi32>) outs([[VAR_8_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>) {
...
// CHECK:             [[VAR_23_1_:%.+]] = tptr.ptradd [[IN_1_]] [[VAR_22_1_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
// CHECK:             linalg.yield [[VAR_23_1_]] : !ptr.ptr<#ptr.generic_space>
// CHECK:           } -> tensor<16x!ptr.ptr<#ptr.generic_space>>
// CHECK:           [[VAR_10_:%.+]] = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins([[VAR_9_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>) outs([[VAR_4_]] : tensor<16xi32>) {
// CHECK:           ^bb0([[IN_4_:%.+]]: !ptr.ptr<#ptr.generic_space>, [[IN_5_:%.+]]: i32):
// CHECK:             [[VAR_22_2_:%.+]] = tptr.to_memref [[IN_4_]] : <#ptr.generic_space> to memref<1xi32>
...
// CHECK:           } -> tensor<16xi64>
// CHECK:           [[VAR_13_:%.+]] = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins([[VAR_12_]] : tensor<16xi64>) outs([[VAR_7_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>) {
// CHECK:           ^bb0([[IN_8_:%.+]]: i64, [[IN_9_:%.+]]: !ptr.ptr<#ptr.generic_space>):
// CHECK:             [[VAR_22_4_:%.+]] = tptr.inttoptr [[IN_8_]] : i64 to <#ptr.generic_space>
// CHECK:             linalg.yield [[VAR_22_4_]] : !ptr.ptr<#ptr.generic_space>
// CHECK:           } -> tensor<16x!ptr.ptr<#ptr.generic_space>>
// CHECK:           [[VAR_14_:%.+]] = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins([[VAR_13_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>) outs([[VAR_4_]] : tensor<16xi32>) {
// CHECK:           ^bb0([[IN_10_:%.+]]: !ptr.ptr<#ptr.generic_space>, [[IN_11_:%.+]]: i32):
// CHECK:             [[VAR_22_5_:%.+]] = tptr.to_memref [[IN_10_]] : <#ptr.generic_space> to memref<1xi32>
// CHECK:             [[VAR_23_1_1_:%.+]] = memref.load [[VAR_22_5_]]{{.}}[[CST_0_]]{{.}} : memref<1xi32>
// CHECK:             linalg.yield [[VAR_23_1_1_]] : i32
// CHECK:           } -> tensor<16xi32>
// CHECK:           [[VAR_15_:%.+]] = linalg.fill ins([[VAR_2_]] : !ptr.ptr<#ptr.generic_space>) outs([[VAR_7_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>) -> tensor<16x!ptr.ptr<#ptr.generic_space>>
// CHECK:           [[VAR_16_:%.+]] = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel"]} ins([[VAR_15_]], [[VAR_6_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>, tensor<16xi32>) outs([[VAR_15_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>) {
// CHECK:           ^bb0([[IN_12_:%.+]]: !ptr.ptr<#ptr.generic_space>, [[IN_13_:%.+]]: i32, [[IN_14_:%.+]]: !ptr.ptr<#ptr.generic_space>):
// CHECK-DAG:         [[VAR_1_:%.+]] = ptr.type_offset i32 : i32
// CHECK:             [[VAR_22_6_:%.+]] = arith.muli [[IN_13_]], [[VAR_1_]] : i32
// CHECK:             [[VAR_23_2_:%.+]] = tptr.ptradd [[IN_12_]] [[VAR_22_6_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
// CHECK:             linalg.yield [[VAR_23_2_]] : !ptr.ptr<#ptr.generic_space>
// CHECK:           } -> tensor<16x!ptr.ptr<#ptr.generic_space>>
// CHECK:           [[VAR_17_:%.+]] = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins([[VAR_16_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>) outs([[VAR_11_]] : tensor<16xi64>) {
// CHECK:           ^bb0([[IN_15_:%.+]]: !ptr.ptr<#ptr.generic_space>, [[IN_16_:%.+]]: i64):
// CHECK:             [[VAR_22_7_:%.+]] = tptr.ptrtoint [[IN_15_]] : <#ptr.generic_space> to i64
...
// CHECK:           } -> tensor<16xi64>
// CHECK:           [[VAR_20_:%.+]] = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel"]} ins([[VAR_16_]], [[VAR_5_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>, tensor<16xi32>) outs([[VAR_16_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>) {
...
// CHECK:             [[VAR_23_3_:%.+]] = tptr.ptradd [[IN_22_]] [[VAR_22_10_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
...
// CHECK:           } -> tensor<16xi32>
// CHECK:           linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins([[VAR_20_]], [[VAR_21_]] : tensor<16x!ptr.ptr<#ptr.generic_space>>, tensor<16xi32>) {
// CHECK:           ^bb0([[IN_27_:%.+]]: !ptr.ptr<#ptr.generic_space>, [[IN_28_:%.+]]: i32):
// CHECK:             [[VAR_22_12_:%.+]] = tptr.to_memref [[IN_27_]] : <#ptr.generic_space> to memref<1xi32>
