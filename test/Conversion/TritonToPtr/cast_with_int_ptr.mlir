...
// CHECK-DAG:       [[VAR_4_:%.+]] = tptr.ptradd [[VAR_1_]] [[VAR_3_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
// CHECK-DAG:       [[VAR_5_:%.+]] = ptr.type_offset i8 : i32
// CHECK:           [[VAR_6_:%.+]] = arith.muli [[VAR_5_]], [[CST_10_]] : i32
// CHECK-DAG:       [[VAR_7_:%.+]] = tptr.ptradd [[VAR_4_]] [[VAR_6_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
...
// CHECK-DAG:       [[VAR_11_:%.+]] = tptr.ptradd [[VAR_0_]] [[VAR_10_]] : <#ptr.generic_space>, i64 to <#ptr.generic_space>
// CHECK-DAG:       [[VAR_12_:%.+]] = arith.muli [[VAR_2_]], [[CST_9_]] : i32
// CHECK:           [[VAR_13_:%.+]] = tptr.ptradd [[VAR_11_]] [[VAR_12_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
// CHECK:           [[VAR_14_:%.+]] = tptr.ptrtoint [[VAR_13_]] : <#ptr.generic_space> to i64
// CHECK-DAG:       [[VAR_15_:%.+]] = arith.remsi [[VAR_14_]], [[CST_10_1_]] : i64
// CHECK-DAG:       [[VAR_16_:%.+]] = tptr.ptradd [[VAR_7_]] [[VAR_2_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
// CHECK:           [[VAR_17_:%.+]] = arith.muli [[VAR_15_]], [[VAR_9_]] : i64
// CHECK-DAG:       [[VAR_18_:%.+]] = tptr.ptradd [[VAR_16_]] [[VAR_17_]] : <#ptr.generic_space>, i64 to <#ptr.generic_space>
// CHECK-DAG:       [[VAR_19_:%.+]] = ptr.type_offset i64 : i32
// CHECK:           [[VAR_20_:%.+]] = arith.muli [[VAR_19_]], [[CST_2_]] : i32
// CHECK-DAG:       [[VAR_21_:%.+]] = tptr.ptradd [[VAR_18_]] [[VAR_20_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
...
// CHECK-DAG:       [[VAR_28_:%.+]] = tptr.ptradd [[VAR_25_]] [[VAR_27_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
// CHECK-DAG:       [[VAR_29_:%.+]] = arith.muli [[PARAM_2_]], [[VAR_26_]] : i32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_30_:%.+]] = tptr.ptradd [[VAR_28_]] [[VAR_29_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
// CHECK-DAG:       [[VAR_31_:%.+]] = arith.muli [[VAR_26_]], [[CST_3_]] : i32
// CHECK:           [[VAR_32_:%.+]] = tptr.ptradd [[VAR_30_]] [[VAR_31_]] : <#ptr.generic_space>, i32 to <#ptr.generic_space>
